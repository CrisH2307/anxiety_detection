...
Frontier conditions (GPT-5.4, Claude Haiku 4.5) were run via API, scripts not included; see prompts/classification_prompt.txt for the exact template used.

## Results
See results/*.json for raw output. Table in Section VI of the paper is generated from these files.
